...
public class LinkedListIndexedCollection<T> implements List<T> {
    ...
    private static class LinkedNode<T> {
         ...
         */
        private LinkedNode(T value, LinkedNode<T> previous) {
    ...
    private static class LinkedListIndexedCollectionElementsGetter<T> implements ElementsGetter<T> {
         ...
         */
        private LinkedListIndexedCollectionElementsGetter(LinkedListIndexedCollection<T> collection) {
     ...
     */
    public <U extends T> LinkedListIndexedCollection(Collection<U> collection) {
    ...
    public void add(T value) {
        ...
        if (size == 0) {
            ...
            LinkedNode<T> current = new LinkedNode<>(value, last);
            last.next = current;
            last = current;
        }
        size++;
    ...
    public void insert(T value, int position) {
        ...
        LinkedNode<T> current = getNode(position);
        LinkedNode<T> newNode = new LinkedNode<>(value, current.previous);
